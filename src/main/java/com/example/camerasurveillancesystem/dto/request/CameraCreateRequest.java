...
public class CameraCreateRequest {
    ...
    @Size(max = 100, message = "Mã camera không được vượt quá 100 ký tự")
    @Pattern(regexp = "^[A-Z0-9_-]+$", message = "Mã camera chỉ được chứa chữ in hoa, số, gạch dưới và gạch ngang")
    private String code;
